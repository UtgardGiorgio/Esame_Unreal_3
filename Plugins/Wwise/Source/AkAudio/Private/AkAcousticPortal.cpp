...
void UAkPortalComponent::SetPortalObstructionAndOcclusion(float InPortalObstruction, float InPortalOcclusion)
{
...
void UAkPortalComponent::TickComponent(float DeltaTime, enum ELevelTick TickType, FActorComponentTickFunction * ThisTickFunction)
{
	...
	if (AkAudioDevice)
	{
		...
		{
			AkAudioDevice->SetPortalObstructionAndOcclusion(this, PortalObstruction, PortalOcclusion);
