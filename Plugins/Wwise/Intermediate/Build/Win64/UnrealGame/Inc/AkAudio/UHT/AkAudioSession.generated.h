...
#define FID_Users_studente_Documents_GitHub_Esame_Unreal_3_Plugins_Wwise_Source_AkAudio_Classes_InitializationSettings_AkAudioSession_h_70_GENERATED_BODY \
	friend struct ::Z_Construct_UScriptStruct_FAkAudioSession_Statics; \
	UE_NODEBUG static UScriptStruct* StaticStruct() { return Z_Construct_UScriptStruct_FAkAudioSession(ETypeConstructPhase::Inner); }
...
#define CURRENT_FILE_ID FID_Users_studente_Documents_GitHub_Esame_Unreal_3_Plugins_Wwise_Source_AkAudio_Classes_InitializationSettings_AkAudioSession_h
...
template<> UE_NODEBUG AKAUDIO_NON_ATTRIBUTED_API UEnum* StaticEnum<EAkAudioSessionCategory>();
...
template<> UE_NODEBUG AKAUDIO_NON_ATTRIBUTED_API UEnum* StaticEnum<EAkAudioSessionCategoryOptions>();
...
template<> UE_NODEBUG AKAUDIO_NON_ATTRIBUTED_API UEnum* StaticEnum<EAkAudioSessionMode>();
...
template<> UE_NODEBUG AKAUDIO_NON_ATTRIBUTED_API UEnum* StaticEnum<EAkAudioSessionRouteSharingPolicy>();
