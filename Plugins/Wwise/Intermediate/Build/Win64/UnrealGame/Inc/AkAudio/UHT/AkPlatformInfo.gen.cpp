...
#endif
#define UHT_STATICS Z_Construct_UClass_UAkPlatformInfo_Statics
struct UHT_STATICS
{
#if WITH_METADATA
...
const UECodeGen_Private::FClassParams UHT_STATICS::ClassParams = {
	&Z_Construct_UClass_UAkPlatformInfo,
	nullptr,
...
UClass* Z_Construct_UClass_UAkPlatformInfo(ETypeConstructPhase Phase)
{
	...
	{
		UECodeGen_Private::ConstructUClass(Z_Registration_Info_UClass_UAkPlatformInfo.OuterSingleton, UHT_STATICS::ClassParams);
	}
...
#error UHT_STATICS already defined
#endif
#define UHT_STATICS Z_CompiledInDeferFile_FID_Users_studente_Documents_GitHub_Esame_Unreal_3_Plugins_Wwise_Source_AkAudio_Classes_Platforms_AkPlatformInfo_h__Script_AkAudio_Statics
struct UHT_STATICS
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAkPlatformInfo, TEXT("UAkPlatformInfo"), &Z_Registration_Info_UClass_UAkPlatformInfo, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAkPlatformInfo), 3879369120U) },
	};
}; // UHT_STATICS 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_studente_Documents_GitHub_Esame_Unreal_3_Plugins_Wwise_Source_AkAudio_Classes_Platforms_AkPlatformInfo_h__Script_AkAudio_76c985791482447009bae15477746d0b81642d93{
	TEXT("/Script/AkAudio"),
