...
#include "Wwise/API_2023_1/Platforms/TVOS/TVOSAPI_2023_1.h"
...
void FWwisePlatformAPI_2023_1_TVOS::ChangeAudioSessionProperties(
...
AkDeviceID FWwisePlatformAPI_2023_1_TVOS::GetDeviceIDFromPlayerIndex(int playerIndex)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
