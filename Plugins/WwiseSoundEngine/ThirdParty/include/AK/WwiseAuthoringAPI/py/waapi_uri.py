...
class WAAPI_URI:
    ...
    ak_wwise_core_audio_setconversionplugin = u"ak.wwise.core.audio.setConversionPlugin"
    # Solos an object.
    ...
    ak_wwise_core_blendcontainer_addassignment = u"ak.wwise.core.blendContainer.addAssignment"
    ...
    ak_wwise_core_blendcontainer_addtrack = u"ak.wwise.core.blendContainer.addTrack"
    # Returns a list of a Blend Track assignments.
    ak_wwise_core_blendcontainer_getassignments = u"ak.wwise.core.blendContainer.getAssignments"
    # Removes an assignment from a Blend Track. Equivalent to deleting an entry in the Blend Tracks Editor.
    ak_wwise_core_blendcontainer_removeassignment = u"ak.wwise.core.blendContainer.removeAssignment"
    # Execute a Lua script. Optionally, specify additional Lua search paths, additional modules, and additional Lua scripts to load prior to the main script. The script can return a value. All arguments will be passed to the Lua script in the "wa_args" global variable.
    ...
    ak_wwise_core_gameparameter_setrange = u"ak.wwise.core.gameParameter.setRange"
    ...
    ak_wwise_core_profiler_capturelog_save = u"ak.wwise.core.profiler.captureLog.save"
    ...
    ak_wwise_core_profiler_unregistermeter = u"ak.wwise.core.profiler.unregisterMeter"
    ...
    ak_wwise_ui_layout_getcurrentlayoutname = u"ak.wwise.ui.layout.getCurrentLayoutName"
    # Retrieves the current allocated rectangle of a layout element. An empty rect is returned if the element is not found.
    ak_wwise_ui_layout_getelementrectangle = u"ak.wwise.ui.layout.getElementRectangle"
    # Serializes a specific layout into a JSON format.
    ak_wwise_ui_layout_getlayout = u"ak.wwise.ui.layout.getLayout"
    # Retrieves a list of the factory layout names.
    ak_wwise_ui_layout_getlayoutnames = u"ak.wwise.ui.layout.getLayoutNames"
    # Gets a view, if it exists in the current layout, or creates a new one.
    ak_wwise_ui_layout_getorcreateview = u"ak.wwise.ui.layout.getOrCreateView"
    # Gets the frontend handle of an instantiated view.
    ak_wwise_ui_layout_getviewhandle = u"ak.wwise.ui.layout.getViewHandle"
    # Retrieves a list of all view instances of a layout.
    ak_wwise_ui_layout_getviewinstances = u"ak.wwise.ui.layout.getViewInstances"
    # Retrieves a list of all view types registered in Wwise.
    ak_wwise_ui_layout_getviewtypes = u"ak.wwise.ui.layout.getViewTypes"
    ...
    ak_wwise_ui_layout_switchlayout = u"ak.wwise.ui.layout.switchLayout"
    # Undock a view from a layout.
    ak_wwise_ui_layout_undockview = u"ak.wwise.ui.layout.undockView"
    # Creates a frontend handle and instantiates its widgets.
    ak_wwise_ui_model_createhandle = u"ak.wwise.ui.model.createHandle"
    # Destroys a frontend handle and its widgets.
    ak_wwise_ui_model_destroyhandle = u"ak.wwise.ui.model.destroyHandle"
    # Gets the state of widgets.
    ak_wwise_ui_model_getstate = u"ak.wwise.ui.model.getState"
    # Registers WAFM files and inline widget descriptors.
    ak_wwise_ui_model_registerwafm = u"ak.wwise.ui.model.registerWafm"
    ...
    ak_wwise_ui_signal_click = u"ak.wwise.ui.signal.click"
    # Emits a signal on a widget.
    ak_wwise_ui_signal_emit = u"ak.wwise.ui.signal.emit"
    # Emitted when a toggle button or a checkbox gets toggled.
    ak_wwise_ui_signal_toggle = u"ak.wwise.ui.signal.toggle"
    # Closes a window and unrealizes its widgets.
    ak_wwise_ui_window_close = u"ak.wwise.ui.window.close"
    # Creates a window in which a frontend handle can be instantiated.
    ak_wwise_ui_window_create = u"ak.wwise.ui.window.create"
    # Presents a window and realizes its widgets.
    ak_wwise_ui_window_present = u"ak.wwise.ui.window.present"
