	...
	namespace wwise
	{
		...
		namespace core
		{
			namespace audio
			{
				...
				static const char* convert = "ak.wwise.core.audio.convert";
				...
				static const char* setConversionPlugin = "ak.wwise.core.audio.setConversionPlugin";
				/*! Solos an object. */
			...
			namespace blendContainer
			{
				...
				static const char* addTrack = "ak.wwise.core.blendContainer.addTrack";
				/*! Returns a list of a Blend Track assignments. */
				static const char* getAssignments = "ak.wwise.core.blendContainer.getAssignments";
				/*! Removes an assignment from a Blend Track. Equivalent to deleting an entry in the Blend Tracks Editor. */
				static const char* removeAssignment = "ak.wwise.core.blendContainer.removeAssignment";
			}
			/*! Execute a Lua script. Optionally, specify additional Lua search paths, additional modules, and additional Lua scripts to load prior to the main script. The script can return a value. All arguments will be passed to the Lua script in the "wa_args" global variable. */
			...
			namespace gameParameter
			{
				...
				static const char* setRange = "ak.wwise.core.gameParameter.setRange";
			}
			...
			static const char* ping = "ak.wwise.core.ping";
			namespace plugin
			{
				/*! Retrieves the list of all object types registered in Wwise's object model. This function returns the equivalent of \ref wobjects_index . */
			...
			namespace profiler
			{
				namespace captureLog
				{
					...
					/*! Saves the content of the capture log to a text file according to the given file path. */
					static const char* save = "ak.wwise.core.profiler.captureLog.save";
				}
				...
				static const char* getMeters = "ak.wwise.core.profiler.getMeters";
				...
				static const char* registerMeter = "ak.wwise.core.profiler.registerMeter";
				...
				/*! Unregisters a bus or device that was registered with \ref ak_wwise_core_profiler_registermeter. */
				static const char* unregisterMeter = "ak.wwise.core.profiler.unregisterMeter";
			}
			namespace project
			{
		...
		namespace debug
		{
			...
			static const char* validateCall = "ak.wwise.debug.validateCall";
		}
		namespace ui
		{
			...
			{
				/*! Execute a Lua script. Optionally, specify additional Lua search paths, additional modules, and additional Lua scripts to load prior to the main script. The script can return a value. All arguments will be passed to the Lua script in the "wa_args" global variable. */
				static const char* executeLuaScript = "ak.wwise.ui.cli.executeLuaScript";
				/*! Launch the main window of WwiseXP. */
				static const char* launch = "ak.wwise.ui.cli.launch";
			}
			namespace commands
			{
			...
			namespace layout
			{
				...
				static const char* dockView = "ak.wwise.ui.layout.dockView";
				/*! Retrieves the current layout name. */
				static const char* getCurrentLayoutName = "ak.wwise.ui.layout.getCurrentLayoutName";
				/*! Retrieves the current allocated rectangle of a layout element. An empty rect is returned if the element is not found. */
				static const char* getElementRectangle = "ak.wwise.ui.layout.getElementRectangle";
				/*! Serializes a specific layout into a JSON format. */
				static const char* getLayout = "ak.wwise.ui.layout.getLayout";
				/*! Retrieves a list of the factory layout names. */
				static const char* getLayoutNames = "ak.wwise.ui.layout.getLayoutNames";
				/*! Gets a view, if it exists in the current layout, or creates a new one. */
				static const char* getOrCreateView = "ak.wwise.ui.layout.getOrCreateView";
				/*! Gets the frontend handle of an instantiated view. */
				static const char* getViewHandle = "ak.wwise.ui.layout.getViewHandle";
				/*! Retrieves a list of all view instances of a layout. */
				static const char* getViewInstances = "ak.wwise.ui.layout.getViewInstances";
				/*! Retrieves a list of all view types registered in Wwise. */
				static const char* getViewTypes = "ak.wwise.ui.layout.getViewTypes";
				...
				static const char* switchLayout = "ak.wwise.ui.layout.switchLayout";
				/*! Undock a view from a layout. */
				static const char* undockView = "ak.wwise.ui.layout.undockView";
			}
			namespace model
			{
				/*! Creates a frontend handle and instantiates its widgets. */
				static const char* createHandle = "ak.wwise.ui.model.createHandle";
				/*! Destroys a frontend handle and its widgets. */
				static const char* destroyHandle = "ak.wwise.ui.model.destroyHandle";
				/*! Gets the state of widgets. */
				static const char* getState = "ak.wwise.ui.model.getState";
				/*! Registers WAFM files and inline widget descriptors. */
				static const char* registerWafm = "ak.wwise.ui.model.registerWafm";
				/*! Sets the state of widgets. */
				static const char* setState = "ak.wwise.ui.model.setState";
			}
			namespace project
			{
			...
			namespace signal
			{
				/*! Emitted when a push button or a radio button gets clicked. */
				static const char* click = "ak.wwise.ui.signal.click";
				/*! Emits a signal on a widget. */
				static const char* emit = "ak.wwise.ui.signal.emit";
				/*! Emitted when a toggle button or a checkbox gets toggled. */
				static const char* toggle = "ak.wwise.ui.signal.toggle";
			}
			namespace window
			{
				/*! Closes a window and unrealizes its widgets. */
				static const char* close = "ak.wwise.ui.window.close";
				/*! Creates a window in which a frontend handle can be instantiated. */
				static const char* create = "ak.wwise.ui.window.create";
				/*! Presents a window and realizes its widgets. */
				static const char* present = "ak.wwise.ui.window.present";
			}
		}
		namespace waapi
		{
