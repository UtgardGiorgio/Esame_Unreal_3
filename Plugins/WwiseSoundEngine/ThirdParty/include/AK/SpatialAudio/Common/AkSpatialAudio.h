...
struct AkRoomParams
{
	...
	/// Default priority is 100. The outdoor Room ignores \c AkRoomParams::RoomPriority and always has the lowest possible priority of -FLT_MAX.
...
namespace AK
{
	...
	namespace SpatialAudio
	{
		...
		/// If no listener is explicitly registered to spatial audio, then a default listener (set via \c AK::SoundEngine::SetDefaultListeners()) is selected.  If the are no default listeners, or there are more than one
